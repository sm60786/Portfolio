...
const Info = {
    ...
    stack: ["Software Test Engineer", "Data Scientist", "Competitive Programmer", "Freelancer", "Open Source Contributor"],
...
const ProjectInfo = [
    {
        ...
        link: "https://github.com/sm60786/Disable-Touchpad-While-Typing-Linux",
        github: "https://github.com/sm60786/Disable-Touchpad-While-Typing-Linux"
    },
    {
...
const socialLinks = [
    { link: "https://github.com/sm60786/", icon: IconBrandGithub },
    { link: "https://www.linkedin.com/in/sibaramm/", icon: IconBrandLinkedin },
    { link: "https://www.instagram.com/__sibaram/", icon: IconBrandInstagram }, 
    { link: "https://www.youtube.com/@sibarammoharana7375", icon: IconBrandYoutube },
    { link: "https://leetcode.com/u/SibaramMoharana/", icon: IconBrandLeetcode }
];
...
const ExperienceInfo = [
    {
        ...
        desc: "As a Software Development Engineer in Test (SDET) at Shyena Solutions, I am responsible for ensuring the quality and reliability of applications through manual testing and comprehensive analysis. I work extensively with tools like Postman for API testing, Bugzilla for bug tracking and reporting, and TestLink for managing test cases. I have designed Grafana dashboards for data visualization and conducted data analysis using Python. Additionally, I have used PostgreSQL for database testing to ensure that data is accurately reflected in Grafana dashboards and verify the backend processes, such as the creation of user accounts and roles. My testing extends to debugging frontend and backend issues using Chrome Developer Tools. Moreover, I have contributed valuable enhancements to the project, many of which have been implemented, adding measurable value to the product.",
        skills: ["Python", "Data Visualization", "Data Analysis", "PostgreSQL", "Postman", "MongoDB", "Microservices"]
    },
    {
